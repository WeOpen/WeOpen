...
- Create: `services/api/migrations/000001_core.up.sql`
- Create: `services/api/migrations/000001_core.down.sql`
...
- Modify: `services/api/internal/http/server.go`
- Modify: `services/api/migrations/000001_core.up.sql`
...
- Create: `services/api/migrations/000002_blog.up.sql`
- Create: `services/api/migrations/000002_blog.down.sql`
...
- Create: `services/api/migrations/000003_storage.up.sql`
- Create: `services/api/migrations/000003_storage.down.sql`
...
- Create: `services/api/migrations/000004_domains.up.sql`
- Create: `services/api/migrations/000004_domains.down.sql`
