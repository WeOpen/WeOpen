...
// Plugin exposes browser-safe developer tools through the platform plugin contract.
type Plugin struct{}
...
func (p Plugin) Manifest() plugin.Manifest {
	return plugin.Manifest{
		...
		Navigation:  []plugin.NavItem{{Title: "Tools", Path: "/tools", Icon: "wrench", Order: 20}},
	}
}

// RegisterRoutes has no side effects because client-safe tools run without API calls.
